			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="form-group"><label for="">Payee</label><input name="payee" type="text"
							value="{{ old('payee') ?? ($payee ?? '') }}"class="form-control">
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="form-group"><label for="">PV No</label><input type="text"
							value="{{ old('pv_no') }}"class="form-control" name="pv_no">
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="form-group"><label for="">Date</label><input type="date" value="{{ old('txn_date') }}"
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="form-group"><label for="">Bank</label>
						<select type="text" id="banks" name="bank" value="{{ old('bank') }}"class="form-control">
						</select>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="form-group"><label for="">Bank Branch</label><input type="text" name="bank_branch"
							class="form-control" value="{{ old('bank_branch') }}"></div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="form-group"><label for="">Account No</label><input type="number"
							value="{{ old('account_no') }}" name="account_no" maxlength="10" class="form-control"></div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-8 col-md-12">
					<div class="form-group"><label for="">Account Code</label>
						...
						<select name="account_code" id="account_code" class="form-control select2">
							...
							@foreach ($coa as $c)
								<option value="{{ $c->EconSegCode }}" {{ old('account_code') == $c->EconSegCode ? 'selected' : '' }}>
				...
				<div class="col-lg-4">
					<div class="form-group"><label for="">Amount</label><input type="number" id="amount"
							step="0.01"name="amount" value="{{ old('amount') ?? ($amount ?? '') }}" class="form-control">
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-2">
					<div class="form-group">
						<label for="">VAT</label>
						<input class="form-control"type="number" name="vat" id="vat" step="0.01">
					</div>
				...
				<div class="col-lg-2">
					<div class="form-group">
						...
						<input class="form-control"type="number" name="stamp_duty" id="stamp" step="0.01">
					</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="form-group">
						...
						<textarea class="form-control" name="detailed_description"cols="95" value="">{{ old('detailed_description') ?? ($description ?? '') }}</textarea>
					</div>
				</div>
				<div class="col-lg-4 ">
